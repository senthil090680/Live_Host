...
<span id="printopen" style="padding-left:470px;padding-top:10px;<?php if($num_rows > 0 ) { echo "display:block;"; } else { echo "display:none;"; } ?>" ><input type="button" name="kdproduct" value="Print" class="buttons" onclick="print_pages('printkdsalesfocusajax');"></span>
<form id="printkdsalesfocusajax" target="_blank" action="printkdsalesfocusajax.php" method="post">
