...
<div id="mainarea">
<div class="mcf"></div>
<div align="center" class="heading_report">KD FOCUS PRODUCTS SALES PERFORMANCE</div>
	...
	<td align="left" nowrap="nowrap" style="width:20%" class="alignsize">
			<span id="brandspan">
				<select class="dsrname" name="brandcode[]" id="brandcode" multiple onChange="getbrandspecific(this.value);">
					...
					<option value="<?php echo $brandstr; ?>"> ALL</option>
	...
	<td align="left" style="width:4%" nowrap="nowrap" class="align2 alignsize">
			<span id="productspan">
				<select class="dsrname" style="width:460px;" name="prodcode" id="prodcode" multiple onChange="getprodspecific(this.value);">
					...
					<option value="<?php echo $productstr; ?>"> ALL</option>
...
<table style="background-color:#CCC">-->
       ...
       <td class="align alignsize">
        ...
        <td align="left" nowrap="nowrap" class="alignsize">
			<div id="dailydate" style="display:none;"><input type="text" name="dailydates" id="dailydates" onChange="changeDateFormat(this.value,'dailydates')" class="datepicker" value="<?php echo date('Y-m-d'); ?>" size="15">&nbsp;&nbsp;
			<input type="button" class="buttons" onClick="kdsalesfocusperform();" value="GO" />
			</div>
			<div id="weeklydate" style="display:none;"><input type="text" name="weeklydates" id="weeklydates" onChange="changeDateFormat(this.value,'weeklydates')" class="datepicker" value="<?php echo date('Y-m-d'); ?>" size="15">
			&nbsp;&nbsp;
			<input type="button" class="buttons" onClick="kdsalesfocusperform();" value="GO" />
			</div>
		...
		<td height="28" align="left" style="width:20%" colspan="2" nowrap="nowrap" class="align">-->
			...
			<div id="fromdate" style="display:none;">  <input type="text" size="9" readonly class="datepicker" name="fromdates" id="fromdates"  onChange="changeDateFormat(this.value,'fromdates')" value="<?php echo date('Y-m-d'); ?>" />	&nbsp;&nbsp; <input type="text" size="9" readonly class="datepicker" name="todates" id="todates" onChange="changeDateFormat(this.value,'todates')" value="<?php echo date('Y-m-d'); ?>" />  &nbsp;&nbsp;
			<input type="button" class="buttons" onClick="kdsalesfocusperform();" value="GO" /></div>
	   ...
	   <div class="condaily_routeplan"> 
		<span id="ajaxresultpage">
		  <table border="1" width="100%">
			<thead>
			  <tr>
				<th align="center" style="width:10%">KD Nameere</th>
