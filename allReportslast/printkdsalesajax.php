...
if(isset($_REQUEST[freqval]) && $_REQUEST[freqval] !='') {
	...
	$query_trans									=   "SELECT KD_Code,DSR_Code,Product_code,Transaction_Number,Sold_Quantity AS SUM_SQ,Value AS VALUE_NAIRA FROM transaction_line WHERE Transaction_Number IN ('".$transno_Total."') $prodcodecol ORDER BY Transaction_Number";
	//echo $query_trans;
	//exit;
