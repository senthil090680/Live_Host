...
<tr>
	...
	//}
	 ...
	 <td><?php if($TRANSLINO == 1) { 
		...
		?></td>	
	 <td><?php if($TRANSLINO == 1) { echo number_format(trim($SearchVal[TRANSVAL]));
		}
	 ?></td>	
	 <td><?php if($TRANSLINO == 1) { echo number_format(trim($SearchVal[DISVAL])); } ?></td>	
	 <td><?php if($TRANSLINO == 1) { echo number_format(trim($SearchVal[CUR])); } ?></td>
	 <td><?php if($TRANSLINO == 1) { echo number_format(trim($SearchVal[NETVAL])); } ?></td>	
	 <td><?php if($TRANSLINO == 1) { echo number_format(trim($SearchVal[COLVAL])); } ?></td>	
	 <td><?php if($TRANSLINO == 1) { echo number_format(trim($SearchVal[BALVAL])); } ?></td>		
	 ...
	 <td><?php echo number_format(trim($SearchVal[PRICEVAL])); ?></td>	
	 <td><?php echo number_format(trim($SearchVal[VALUEVAL])); ?></td>	
