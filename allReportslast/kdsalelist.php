...
<div id="mainarea">
<div class="mcf"></div>
<div align="center" class="heading_report">KD SALE LIST</div>
<div id="mytableform_report" align="center">
<div class="mcf"></div>
<!-- <form method="post" action="" id="routemasterplan"> -->
<table width="100%" style="background-color:#CCC;border-collapse:collapse" >
 <tr>
...
<tr>
	...
	<td align="left" style="width:4%" nowrap="nowrap" class="align2 alignsize">
        <span id="productspan">
				<select class="dsrname" name="prodcode[]" id="prodcode" multiple onChange="getprodspecific(this.value);">
...
<table style="background-color:#CCC" width="100%">	  -->
	   ...
	   <tr align="center">
        <?php //$curmonth		=	date('F',strtotime("-1 months")); ?>
		<td align="left" style="width:9%;" class="align alignsize" nowrap="nowrap" >FROM & TO DATE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
		<td align="left" style="width:10%" class="align2 alignsize" nowrap="nowrap">
		<div id="tobecopied" > 
        <input type="text" size="9" readonly class="datepicker" name="fromdates" id="fromdates"  onChange="changeDateFormat(this.value,'fromdates')" value="<?php echo date('Y-m-d'); ?>" />	&nbsp;&nbsp;
        &nbsp; <input type="text" size="9" readonly class="datepicker" name="todates" id="todates" onChange="changeDateFormat(this.value,'todates')" value="<?php echo date('Y-m-d'); ?>" />  &nbsp; &nbsp;
       <input type="button" class="buttons" onClick="kdsaleslist();" value="GO" />
        </div>
         </td>   
	  </tr>
	 </table>
