...
$sql="INSERT INTO `kd`
(`KD_Code`,`KD_Name`,`Address_Line_1`,`Address_Line_2`,`Address_Line_3`,`City`,`Pin`,`Contact_Person`,`Contact_Number`,`Email_ID`,`kd_category`,`kd_analysis`,`miscellaneous_caption`,`miscellaneous_data`)
values('$KD_Code','$KD_Name','$Address_Line_1','$Address_Line_2','$Address_Line_3','$City','$Pin','$Contact_Person','$Contact_Number','$Email_ID','$kd_category','$kd_analysis','$miscellaneous_caption','$miscellaneous_data')";
mysql_query( $sql);
