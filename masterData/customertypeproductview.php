...
<span style="float:left;">&nbsp;&nbsp;<input type="button" value="Back" class="buttons" onclick="window.location='customertypeproduct.php'"></span>
 <div id="search">
        ...
        <input type="button" class="buttonsg" onclick="custypeviewajaxsearch('<?php echo $Page; ?>');" value="GO"/>
 </div>
...
<th nowrap="nowrap" style="width:10%" class="rounded" onClick="productviewajax('<?php echo $Page;?>','<?php echo $paramsval; ?>');">Code<img src="../images/sort.png" width="13" height="13" /></th>
        ...
        <input type="button" name="cancel" value="Cancel" class="buttons" onclick="window.location='customertypeview.php'"/>
        </form>
        </div>    
