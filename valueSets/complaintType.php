...
$sql =("UPDATE feedback_type SET 
        feedback_type='$feedback_type'
       	WHERE id =$id");
mysql_query( $sql);
header("location:complaintType.php?no=2");
}
else{
header("location:complaintType.php?no=18");
}
}
}
...
if($feedback_type=='')
{
header("location:complaintType.php?no=9");exit;
}
else{
$sel="select * from feedback_type where feedback_type ='$feedback_type'";
$sel_query=mysql_query($sel);
        ...
        mysql_query( $sql);
        header("location:complaintType.php?no=1");
		}
		else {
		header("location:complaintType.php?no=18");
		}
  ...
  <tr height="60px;">
   ...
   <tr align="center" height="70px;">
       <td colspan="10"><input type="submit" name="submit" id="submit" class="buttons" value="Save" />&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="reset" name="reset" id="reset"  class="buttons" value="Clear" id="clear" onclick='return stateClear()'/>&nbsp;&nbsp;&nbsp;&nbsp;
...
<?php include("../include/error.php");?>
    ...
    <input type="text" name="feedback_type" value="<?php $_GET['feedback_type']; ?>" autocomplete='off' placeholder='Search By Feedback Type'/>
...
<div id="container">
        ...
        //Set the query to return names of all employees
       	$query="update feedback_type set where id='$id'";
        //Run the query
		...
		<td align="right">
        <a href="complaintType.php?id=<?php echo $fetch['id'];?>"><img src="../images/user_edit.png" alt="" title="" width="11" height="11"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="complaintType.php?id=<?php echo $fetch['id'];?>&no=3" class="ask"><img src="../images/trash.png" alt="" title="" width="11" height="11" /></a>
        </td>
        </tr>
		<?php $c++; $cc++; }		 
