	...
	?>
	 <tr>
		 ...
		 //echo $checkfor ."==" .$checkoutfor."<br>"; ?> Sub Total<strong></td>
		  ...
		  <td>&nbsp;
		  <table  width="100%"><tr><td><?php echo $total_vists; ?></td><td><?php echo number_format(trim($total_sales)); ?></td><td><?php echo $total_prod_cov; ?></td></tr></table>
		  </td>
	 </tr>
<?php
	$checkfor			=	'';
 ...
 <?php $k++; } ?>
  ...
  <tr>
		 ...
		 //echo $checkfor ."==" .$checkoutfor."<br>"; ?> Grand Total<strong></td>
		  ...
		  <td>&nbsp;
		  <table  width="100%"><tr><td><?php echo $tot_vists; ?></td><td><?php echo number_format(trim($tot_sales)); ?></td><td><?php echo $tot_prod_cov; ?></td></tr></table>
		  </td>
	 </tr>
 </tbody>	
</table>
