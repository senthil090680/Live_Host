	...
	?>
	 <tr>
		 ...
		 //echo $checkfor ."==" .$checkoutfor."<br>"; ?> Sub Total<strong></td>
		  <td align="right">&nbsp;<?php echo number_format(trim($total_preout)); ?></td>
		  <td>&nbsp;
		  <table  width="100%"><tr><td align="right"><?php echo number_format(trim($total_salval)); ?></td><td align="right"><?php echo number_format(trim($total_colval)); ?></td><tdalign="right"><?php echo number_format(trim($total_balval)); ?></td></tr></table>
		  </td>
		  <td align="right">&nbsp;<?php echo number_format(trim($total_totbal)); ?></td>	
		  <td align="right">&nbsp;<?php echo number_format(trim($total_avgsal)); ?></td>	
		  <td align="right">&nbsp;<?php echo number_format(trim($total_ossal)); ?></td>	
	 </tr>
<?php
	$checkfor			=	'';
	$subtotalcheckfor	=	'';
...
<tr>
	 ...
	 <td ><?php echo $SearchVal[PREVAL]; ?></td>	
	  <td>&nbsp; <table  width="100%"><tr><td align="right"><?php echo number_format(trim($SearchVal[SALVAL])); ?></td><td align="right"><?php echo number_format(trim($SearchVal[COLVAL])); ?></td><td align="right"><?php echo number_format(trim($SearchVal[BALVAL])); ?></td></tr></table></td>
	  <td align="right"><?php echo number_format(trim($SearchVal[TOTALBAL])); ?></td>	
	  <td align="right"><?php echo number_format(trim($SearchVal[AVG_SAL])); ?></td>
	  <td align="right"><?php echo number_format(trim($SearchVal[OSSALE])); ?></td>
 </tr>
 ...
 <?php $k++; } ?>
   <tr>
	 ...
	 //echo $checkfor ."==" .$checkoutfor."<br>"; ?> Sub Total<strong></td>
	  <td align="right">&nbsp;<?php echo number_format(trim($total_preout)); ?></td>
	  <td>&nbsp;
	  <table  width="100%"><tr><td align="right"><?php echo number_format(trim($total_salval)); ?></td><td align="right"><?php echo number_format(trim($total_colval)); ?></td><td align="right"><?php echo number_format(trim($total_balval)); ?></td></tr></table>
	  </td>
	  <td align="right">&nbsp;<?php echo number_format(trim($total_totbal)); ?></td>	
	  <td align="right">&nbsp;<?php echo number_format(trim($total_avgsal)); ?></td>	
	  <td align="right">&nbsp;<?php echo number_format(trim($total_ossal)); ?></td>	
  ...
  <tr>
	<td colspan="5" align="right"><strong><?php 
	 ...
	 //echo $checkfor ."==" .$checkoutfor."<br>"; ?> Grand Total<strong></td>
	  <td align="right">&nbsp;<?php echo number_format(trim($tot_preout)); ?></td>
	  <td>&nbsp;
	  <table  width="100%"><tr><td align="right"><?php echo number_format(trim($tot_salval)); ?></td><td align="right"><?php echo number_format(trim($tot_colval)); ?></td><td align="right"><?php echo number_format(trim($tot_balval)); ?></td></tr></table>
	  </td>
	  <td align="right">&nbsp;<?php echo number_format(trim($tot_totbal)); ?></td>	
	  <td align="right">&nbsp;<?php echo number_format(trim($tot_avgsal)); ?></td>	
	  <td align="right">&nbsp;<?php echo number_format(trim($tot_ossal)); ?></td>	
 </tr>
 </tbody>	
</table>
<span id="printopen" style="padding-left:470px;padding-top:10px;<?php if($num_rows > 0 ) { echo "display:block;"; } else { echo "display:none;"; } ?>" ><input type="button" name="kdproduct" value="Print" class="buttons" onclick="print_pages('printkdoutajax');"></span>
<form id="printkdoutajax" target="_blank" action="printkdoutajax.php" method="post">
