...
<li><a href="#">Master Data</a>
       <ul>
          ...
          <ul>
            ...
            <li><a href="../valueSets/division.php">Division</a></li>
 ...
 <li><a href="#">Base Data</a>
     <ul>
                    ...
                    <li><a href="../BaseData/transactionentry.php">Device Transactions Entry</a></li>
                    <li><a href="../BaseData/deviceTransview.php">Device Transactions view & Print</a></li>
					...
					<li><a href="../allReports/kdsalesfocusperform.php" title="">KD Focus Products</a></li>
